...
CREATE TABLE balance_ledger (
  ...
  delta_microusd TEXT NOT NULL CHECK(
    ...
    AND (delta_microusd='0' OR delta_microusd GLOB '-[1-9][0-9]*' OR delta_microusd GLOB '[1-9][0-9]*')
  ),
  balance_before_microusd TEXT NOT NULL CHECK(length(balance_before_microusd) BETWEEN 1 AND 40 AND balance_before_microusd NOT GLOB '*[^0-9]*'),
  balance_after_microusd TEXT NOT NULL CHECK(length(balance_after_microusd) BETWEEN 1 AND 40 AND balance_after_microusd NOT GLOB '*[^0-9]*'),
