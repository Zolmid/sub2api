/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 911fcecafbf314f4bd36eb4326e0cc7d)
...
interface __BaseEnv_Env {
	...
	SUB2API_CONTAINER: DurableObjectNamespace<import("./src/index").Sub2APIContainer>;
	ACCOUNT_LEASE: DurableObjectNamespace<import("./src/index").AccountLeaseDO>;
	USER_RATE_LIMIT: DurableObjectNamespace<import("./src/index").UserRateLimitDO>;
	API_KEY_RATE_LIMIT: DurableObjectNamespace<import("./src/index").APIKeyRateLimitDO>;
	BILLING_PRINCIPAL: DurableObjectNamespace<import("./src/index").BillingPrincipalDO>;
	AUTH_LOGIN_ADMISSION: DurableObjectNamespace<import("./src/index").AuthLoginAdmissionDO>;
	TOTP_SECURITY: DurableObjectNamespace<import("./src/index").TOTPSecurityDO>;
	OAUTH_REFRESH_AUTHORITY: DurableObjectNamespace<import("./src/index").OAuthRefreshAuthorityDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sub2APIContainer" | "AccountLeaseDO" | "AuthLoginAdmissionDO" | "TOTPSecurityDO" | "BillingPrincipalDO" | "UserRateLimitDO" | "APIKeyRateLimitDO" | "OAuthRefreshAuthorityDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOW_TEST_FIXTURE" | "SUB2API_CF_UPSTREAM_ALLOWED_HOSTS" | "SUB2API_CF_LEASE_TTL_SECONDS">> {}
}
